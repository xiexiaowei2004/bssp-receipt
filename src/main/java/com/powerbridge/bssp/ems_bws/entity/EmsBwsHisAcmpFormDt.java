 ...
 * @since 2017-06-09
 */
@TableName("ems_bws_his_acmp_form_dt")
public class EmsBwsHisAcmpFormDt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 593622752690046489L;
    /**
     * 主键
     */
    @TableId("UID")
