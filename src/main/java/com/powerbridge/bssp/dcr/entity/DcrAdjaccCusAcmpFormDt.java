 ...
 * @since 2017-07-03
 */
@TableName("dcr_adjacc_cus_acmp_form_dt")
public class DcrAdjaccCusAcmpFormDt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 6325266718042221435L;
    /**
     * 主键
     */
    @TableId("UID")
