 ...
 * @since 2017-07-03
 */
@TableName("dcr_adjacc_his_acmp_form_dt")
public class DcrAdjaccHisAcmpFormDt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 1905644600560282550L;
    /**
     * 主键
     */
    @TableId("UID")
