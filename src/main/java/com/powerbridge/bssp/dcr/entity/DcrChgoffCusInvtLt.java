 ...
 * @since 2017-07-03
 */
@TableName("dcr_chgoff_cus_invt_lt")
public class DcrChgoffCusInvtLt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 6206991566642777823L;
    /**
     * 主键
     */
    @TableId("UID")
