 ...
 * @since 2017-07-05
 */
@TableName("inv_cus_bsc")
public class InvCusBsc implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 9170833937491739883L;
    /**
     * 主键
     */
    @TableField("UID")
    ...
    public void setInvtDclTime(Date invtDclTime) {
    ...
    public void setEntryDclTime(Date entryDclTime) {
    ...
    public Date getPrevdTime() {
        return prevdTime;
    }

    public void setPrevdTime(Date prevdTime) {
        this.prevdTime = prevdTime;
    }

    public Date getFormalVrfdedTime() {
        return formalVrfdedTime;
    }

    public void setFormalVrfdedTime(Date formalVrfdedTime) {
