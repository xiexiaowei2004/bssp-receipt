...
@TableName(value = "sas_passport_his_rlt")
public class SasPassportHisRlt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 5064688181060293676L;
    /**
     * 主键
     *
