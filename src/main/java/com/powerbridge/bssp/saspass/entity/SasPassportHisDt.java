...
@TableName("sas_passport_his_dt")
public class SasPassportHisDt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = -7538866854946054256L;
    /**
     * 主键
     *
