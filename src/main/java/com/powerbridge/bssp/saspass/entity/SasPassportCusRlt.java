...
@TableName(value = "sas_passport_cus_rlt")
public class SasPassportCusRlt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 3598776279287538091L;
    /**
     * 主键
     *
