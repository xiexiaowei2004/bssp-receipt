...
public class StringUtil {
     ...
     */
    private static String nullToDefault(String str, String defaultStr) {
     ...
     */
    private static String cutPreAndLowerFirst(String str, int preLength) {
        if (str == null) {
            return null;
        }
     ...
     * @return 处理后的字符串
     */
    private static String upperFirstAndAddPre(String str, String preString) {
     ...
     * @return 切分后的集合
     */
    private static List<String> split(String str, char separator, int limit) {
        if (str == null) {
            return null;
        }
     ...
     * @return 字串
     */
    private static String sub(String string, int fromIndex, int toIndex) {
     ...
     * @return 编码后的字节码
     */
    private static byte[] bytes(String str, String charset) {
     ...
     * @return 是否被包装
     */
    private static boolean isWrap(String str, String prefix, String suffix) {
        return str.startsWith(prefix) && str.endsWith(suffix);
    }
     ...
     * @return 是否被包装
     */
    private static boolean isWrap(String str, char prefixChar, char suffixChar) {
