...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    private static boolean copyFile(File srcFile, String descFileName) {
...
//        File srcFile = new File(srcFileName);
     ...
     */
    private static boolean copyDirectory(String srcDirName, String descDirName) {
     ...
     * @return 如果复制成功返回true，否则返回false
     */
    private static boolean copyDirectoryCover(String srcDirName,
