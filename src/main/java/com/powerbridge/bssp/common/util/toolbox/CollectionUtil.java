...
class CollectionUtil {
     ...
     * @return 调整后的新数组
     */
    private static <T> T[] resize(T[] buffer, int newSize, Class<?> componentType) {
     ...
     * @return 数字列表
     */
    private static int[] range(int includedStart, int excludedEnd, int step) {
     ...
     */
    private static <T> List<T> sub(List<T> list, int start, int end) {
     ...
     * @return Map
     */
    private static <T, K> Map<T, K> zip(T[] keys, K[] values) {
