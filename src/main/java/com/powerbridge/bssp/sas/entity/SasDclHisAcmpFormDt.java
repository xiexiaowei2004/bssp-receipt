 ...
 * @since 2017-07-01
 */
@TableName("sas_dcl_his_acmp_form_dt")
public class SasDclHisAcmpFormDt implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 4880374344195996078L;
