 ...
 * @since 2017-06-01
 */
@TableName("sas_stock_cus_dt")
public class SasStockCusDt implements Serializable {
     ...
     * 申报总价
     */
    @TableField(value = "DCL_TOTAL_AMT")
    private BigDecimal dclTotalAmt;
    /**
     * 美元统计总价
     */
    @TableField(value = "USD_STAT_TOTAL_AMT")
     ...
     * 法定数量
     */
    @TableField(value = "LAWF_QTY")
    private BigDecimal lawfQty;
    /**
     * 第二法定数量
     */
    @TableField(value = "SECD_LAWF_QTY")
    private BigDecimal secdLawfQty;
    /**
     * 重量比例因子
     */
    @TableField(value = "WT_SF_VAL")
    private BigDecimal wtSfVal;
    /**
     * 第一比例因子
     */
    @TableField(value = "FST_SF_VAL")
    private BigDecimal fstSfVal;
    /**
     * 第二比例因子
     */
    @TableField(value = "SECD_SF_VAL")
